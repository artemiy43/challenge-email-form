...
import picture_back_d from "./assets/images/illustration-sign-up-desktop.svg";
    ...
    <>
      {!isSended ? (
        <main className="text-black text-3xl font-Roboto bg-white flex flex-col gap-12 w-full h-screen sm:w-[600px] sm:flex-row sm:grid sm:gap-6 sm:grid-cols-2 sm:grid-rows-2 sm:p-6 sm:rounded-3xl lg:w-[1000px] lg:pl-16 lg:h-full">
          <div
            className={`bg-[url('./assets/images/illustration-sign-up-mobile.svg')] bg-cover bg-no-repeat w-full h-full sm:bg-[url('./assets/images/illustration-sign-up-desktop.svg')] sm:order-2 sm:row-span-2 lg:w-[400px] lg:h-[593px] lg:place-self-end`}
          />
          <Text />
